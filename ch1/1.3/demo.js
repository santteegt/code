...
const unsignedTx = {
	type: 'cancel',
	amount: aliceTx2.contents.amount,
	from: aliceTx2.contents.from,
	to: aliceTx2.contents.to,
	nonce: aliceTx2.contents.nonce,
};
const aliceTx2Cancellation = {
	contents: unsignedTx,
	sig: alice.sign(unsignedTx),
};
