...
console.log('New Paypal instance', paypal)
//
...
console.log('\nPaypal checks Alice\'s transaction to Bob. Is it valid?', checkAliceTx)
//
// Check user address
...
console.log('Is it?', checkAliceTxType)
...
const checkAliceAccountBalance = alice.generateTx(undefined, undefined, 'check')
